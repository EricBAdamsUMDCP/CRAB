...
process.TFileService = cms.Service("TFileService",fileName=cms.string("rereco_CentandZDC_327464.root"))
...
'/store/hidata/HIRun2018A/HIMinimumBias2/AOD/04Apr2019-v1/610001/D66B4AC2-F704-2540-8202-B8FF624DA67E.root' #[181]
))
...
process.analyzer = cms.EDAnalyzer('OnlyZDCandCentralityAnalyzer',
