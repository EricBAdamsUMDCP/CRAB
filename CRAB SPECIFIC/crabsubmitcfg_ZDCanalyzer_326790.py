#import FWCore.ParameterSet.Config as cms //uncomment if needed
from CRABClient.UserUtilities import config

#process.source = cms.Source ("PoolSource",fileNames = cms.untracked.vstring()) #Added 5/13

config = config()
config.General.requestName = 'PbPb2018_AOD_MinBias2_326790_RPDZDC'
config.General.transferLogs = True
config.General.transferOutputs = True
config.section_('JobType')
config.JobType.outputFiles = ['PbPb2018_AOD_MinBias2_326790_RPDZDC.root']
