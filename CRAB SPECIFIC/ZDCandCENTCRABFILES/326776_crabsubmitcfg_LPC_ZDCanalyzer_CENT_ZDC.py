...
config = config()
config.General.requestName = 'rereco_PbPb2018_AOD_MinBias2_326776_ZDC_and_CENT'
config.General.transferLogs = True
config.General.transferOutputs = True
config.section_('JobType')
config.JobType.outputFiles = ['rereco_ZDC_AND_CENT_PbPb2018_AOD_MinBias2_326776.root']
config.JobType.pyCfgParams = ['noprint']
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '326776_rerecoForCRABpythonfileforModernProductionofZDC_and_CENT.py' #MUST BE IN SAME FOLER OR GIVE FULL PATH
