...
config = config()
config.General.requestName = 'rereco_PbPb2018_AOD_MinBias2_326883_ZDC'
config.General.transferLogs = True
config.General.transferOutputs = True
config.section_('JobType')
config.JobType.outputFiles = ['rereco_PbPb2018_AOD_MinBias2_326883_RPDZDC.root']
config.JobType.pyCfgParams = ['noprint']
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'rerecoForCRABpythonfileforModernProduction_326883.py' #MUST BE IN SAME FOLER OR GIVE FULL PATH
